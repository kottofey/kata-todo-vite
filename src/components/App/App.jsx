...
import reducedHash from '../../helpers/reducedHash.js';
...
export default class App extends Component {
  state = {
    todoItems: [
      ...
      { description: 'No defined taskState task', created: '9-12-2024 12:00' },
    ],
  };

  deleteItem = (id) => {
    this.setState(({ todoItems }) => {
      const idx = todoItems.findIndex((item) => reducedHash(item.description) === id);
